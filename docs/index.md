...
hero:
  name: Movera
  text: The Trust Layer for Move
  tagline: Decentralized attestation infrastructure powered by MoveAS Protocol
  image:
    src: /mas-logo.svg
    alt: Movera Logo
  actions:
    ...
    - theme: alt
      text: View on GitHub
      link: https://github.com/BoringIdea/movera
...
features:
  ...
  - icon: 📋
    title: Schema-Based
    details: Flexible schema system for defining attestation data structures
  - icon: ⚙️
    title: Resolver Pattern
    details: Custom validation logic for access control
  - icon: 📦
