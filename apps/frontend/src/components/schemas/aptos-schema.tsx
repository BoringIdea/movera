        ...
        <section className="border border-black bg-white px-6 py-5">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            ...
            <button
              ...
              className="rounded-none border border-black bg-[#27cdff] px-5 py-2 text-xs font-black uppercase tracking-[0.25em] text-white hover:bg-[#1f75d4]"
            >
              Attest with schema
            </button>
          </div>
        ...
        <section className="border border-black bg-white px-6 py-5 space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              <p className="font-bold text-black">{schema.resolver !== '0x0' ? 'Yes' : 'None'}</p>
            </div>
          </div>
        </section>
