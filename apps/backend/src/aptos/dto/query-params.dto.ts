...
export class SchemaAddressParamDto {
  @ApiProperty({
    description: 'Schema address in Aptos network',
...
export class AttestationAddressParamDto {
  @ApiProperty({
    description: 'Attestation address in Aptos network',
...
export class UserAddressParamDto {
  @ApiProperty({
    description: 'User address in Aptos network',
...
export class AttestationsBySchemaQueryDto extends PaginationQueryDto {
  @ApiProperty({
    description: 'Schema address to filter attestations',
    example: '0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef',
  })
...
export class AttestationsByUserQueryDto extends PaginationQueryDto {
  @ApiProperty({
    description: 'User address to filter attestations (as attestor or recipient)',
    example: '0x9876543210fedcba9876543210fedcba9876543210fedcba9876543210fedcba',
  })
