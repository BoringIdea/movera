...
@ApiTags('Aptos Attestation Service')
@Controller('api/v1/aptos')
...
export class AptosController {
  ...
  async getSchemas(@Query() query: PaginationQueryDto): Promise<IApiResponse<any[]>> {
    const paginationData = await this.aptosService.getSchemasWithPaginationFromGraphQL(
      query.offset || 0,
      query.limit || 10,
    );
  ...
  async searchSchemas(@Query() query: SearchSchemaQueryDto): Promise<IApiResponse<SchemaResponseDto[]>> {
    const schemas = await this.aptosService.searchSchemaFromGraphQL(query.searchInput);
  ...
  async getSchemaCount(): Promise<IApiResponse<CountResponseDto>> {
    const count = await this.aptosService.getSchemaCountFromGraphQL();
  ...
  async getSchemaCreatorCount(): Promise<IApiResponse<CountResponseDto>> {
    const count = await this.aptosService.getSchemaCreatorCntFromGraphQL();
  ...
  async getSchemaByAddress(@Param('schemaAddress') schemaAddress: string): Promise<IApiResponse<SchemaResponseDto>> {
    const schema = await this.aptosService.findSchemaByAddressFromGraphQL(schemaAddress);
    if (!schema) {
  ...
  async getAttestations(@Query() query: PaginationQueryDto): Promise<IApiResponse<any[]>> {
    const paginationData = await this.aptosService.getAttestationsWithPaginationFromGraphQL(
      query.offset || 0,
      query.limit || 10,
    );
  ...
  async getAttestationCount(): Promise<IApiResponse<CountResponseDto>> {
    const count = await this.aptosService.getAttestationCountFromGraphQL();
  ...
  async getAttestorCount(): Promise<IApiResponse<CountResponseDto>> {
    const count = await this.aptosService.getAttestorCountFromGraphQL();
  ...
  async getAttestationsBySchema(
    ...
    const paginationData = await this.aptosService.getAttestationsBySchemaWithPaginationFromGraphQL(
      schema,
      query.offset || 0,
      query.limit || 10,
    );
  ...
  async getAttestationCountBySchema(@Param('schema') schema: string): Promise<IApiResponse<CountResponseDto>> {
    const count = await this.aptosService.getAttestationCntBySchemaFromGraphQL(schema);
  ...
  async getAttestationsByUser(
    ...
    const paginationData = await this.aptosService.getAttestationsByUserWithPaginationFromGraphQL(
      address,
      query.offset || 0,
      query.limit || 10,
    );
  ...
  async getAttestationCountByUser(@Param('address') address: string): Promise<IApiResponse<CountResponseDto>> {
    const count = await this.aptosService.getAttestationCntByUserFromGraphQL(address);
  ...
  async getAttestationCountByCreator(@Param('address') address: string): Promise<IApiResponse<CountResponseDto>> {
    const count = await this.aptosService.getAttestationCntByCreatorFromGraphQL(address);
  ...
  async getAttestationCountByRecipient(@Param('address') address: string): Promise<IApiResponse<CountResponseDto>> {
    const count = await this.aptosService.getAttestationCntByRecipientFromGraphQL(address);
  ...
  async getAttestationByAddress(@Param('address') address: string): Promise<IApiResponse<AttestationWithSchemaResponseDto>> {
    const attestation = await this.aptosService.getAttestationAndSchemaFromGraphQL(address);
    if (!attestation) {
